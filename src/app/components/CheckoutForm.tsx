...
const CheckoutForm = ({ secret, subscriptionId }: CheckoutFormProps) => {
  ...
  useEffect(() => {
    ...
    console.log("Hello Checkout FOrm", secret);
    ...
    try {
      const result = await stripe.confirmPayment({
        ...
        confirmParams: {
          ...
          }/payment-success?session_id=${subscriptionId}&id=${localStorage.getItem(
            "IASID"
          )}&plan=${plan}&price=${parseInt(price) * parseInt(quant)}`,
          // return_url: `${process.env.NEXT_PUBLIC_FRONTEND_URL}/payment-success?session_id={CHECKOUT_SESSION_ID}&id=${100000}`,
        },
      });
  ...
  return (
    <div className="w-11/12 flex flex-col  lg:flex-row lg:pt-16 mx-3 lg:gap-24  text-white">
      <div className="flex flex-col">
        ...
        <div className="w-full lg:w-3/4 p-4 lg:mx-28 flex flex-col ">
          ...
          <h2 className="text-xl md:text-4xl font-semibold mb-4">
            ...
            {/* {price} <span className="text-gray-500 text-base">PKR {option}</span> */}
          </h2>
          ...
          <div className="mb-4 mt-10 text-black-important">
            <div className="flex justify-between mb-4">
              <div>
                ...
                <p className="text-xs text-black-important ">Billed One Time</p>
              </div>
      ...
      <div className="w-full min-h-screen lg:w-1/2 p-4 flex flex-col left-shadow shadow-black">
        <form className="space-y-6 lg:ml-16" onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              autoComplete="off"
              // readOnly
              value={localStorage.getItem("IASEMAIL") || ""}
