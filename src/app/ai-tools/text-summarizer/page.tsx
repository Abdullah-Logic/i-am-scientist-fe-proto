...
export default function TextSummarizer() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const response = await fetch("https://api.iamscientist.ai/api/summarizer/summarize", {
                method: "POST",
                headers: {
                ...
                body: JSON.stringify({
                    text: originalText,
                    summaryLength: length || "concise", // Defaulting to concise if length is empty
                }),
            });
            ...
            console.error("Summarization Linking Error:", error);
      ...
      <button className="cwd-back-btn" onClick={() => router.back()}>
        ...
        Back
                ...
                <div className="ts-breadcrumb">
                    ...
                    <span className="ts-breadcrumb-current">Text Summarizer</span>
                </div>
                <div className="ts-container">
                    ...
                    <div className="ts-panel">
                            ...
                            <div className="ts-form">
                                ...
                                <div className="ts-title-row">
                                    <div className="ts-title-left">
                                        <h1 className="ts-title">Text Summarizer</h1>
                                        <button className="ts-refresh-btn" title="Reset" onClick={() => { setLength(""); setOriginalText(""); }}>
                                ...
                                <p className="ts-subtitle">Summarize any text in whatever length you choose.</p>

                                {/* Length of Summary */}
                                <div className="ts-field">
                                    <label className="ts-label">
                                        Length of summary: <span className="ts-required">*</span>
                                    </label>
                                    <div className="ts-input-wrapper">
                                        ...
                                        <input
                                            className="ts-input"
                                            type="text"
                                            placeholder="1 paragraph, 1 page, 5 bullet points, 500 words"
                                            value={length}
                                ...
                                <div className="ts-generate-row">
                                    ...
                                    >
                                        ...
                                        {isGenerating ? "Summarizing..." : "Generate"}
                                     </button>
                        ...
                        {/* --- NEW SUMMARY OUTPUT VIEW --- */}
                        {!isEditorOpen && summaryResult && (
                            <div className="ts-output-area" style={{ padding: '20px', color: 'white', borderTop: '1px solid rgba(135,45,230,0.3)', overflowY: 'auto' }}>
                                <h2 style={{ fontSize: '1.2rem', marginBottom: '1rem', color: '#a855f7' }}>Summary:</h2>
                                ...
                                <button className="ts-generate-btn" style={{ marginTop: '20px' }} onClick={() => setIsEditorOpen(true)}>Summarize Another Text</button>
                            </div>
                        )}
    ...
    gap: 0.5rem;
                ...
                .ts-input:focus { border-color: #872de6; }
                .ts-input::placeholder { color: rgba(255,255,255,0.25); }
