...
import Generator from "@/app/components/Tools/content-generator/Generator";

const Response = dynamic(() => import("@/app/components/Tools/Response"), {
  ssr: false,
});
...
const ModuleLayout = () => {
  ...
  return (
    <div className="md:px-20 md:py-10 p-6 w-full mx-auto text-white overflow-y-auto bg-[#280253] font-popins">
      {/* Top Section */}
      <div className="w-full pb-4">
        {/* Top Breadcrumbs */}
        <div className="text-base text-slate-400 font-light p-2 flex items-center gap-2">
          <Link href="/free-tools" className="font-semibold">Templates</Link>
          <FaChevronRight className="text-sm" />
          <Link href={`/free-tools/tools/${module}`} className="capitalize font-semibold">
            {pageTitle}
          </Link>
        </div>
