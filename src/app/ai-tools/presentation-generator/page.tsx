...
export default function PresentationGenerator() {
  ...
  const numSlidesOptions = ["5", "10", "15", "20", "25", "30"];
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch(
        "https://api.iamscientist.ai/api/ppt/generate-ppt",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            topic:
              topic + (criteria ? ` Additional Criteria: ${criteria}` : ""),
            slideCount: numSlides,
            gradeLevel: gradeLevel, // Sent but backend currently uses professional prompt
          }),
        },
      );
      ...
      console.error("PPT Linking Error:", error);
      alert(
        "Failed to connect to the backend. Ensure your Flask server is running.",
      );
    } finally {
  ...
  return (
    <DashboardLayout activeTab="All Magic Tools">
      <div className="pg-page">
        ...
        <div className="pg-breadcrumb">
          <Link href="/teacher/tools" style={{ textDecoration: "none" }}>
            <span className="pg-breadcrumb-tools">Tools</span>
          </Link>
          <svg
            width="14"
            height="14"
          ...
          <span className="pg-breadcrumb-current">Presentation Generator</span>
        </div>
        <div className="pg-container">
          ...
          <div className="pg-panel">
              ...
              <div className="pg-form">
                ...
                <div className="pg-title-row">
                  <div className="pg-title-left">
                    <h1 className="pg-title">Presentation Generator</h1>
                    <button
                  ...
                  <button className="pg-exemplar-btn">Show exemplar</button>
                </div>

                <p className="pg-subtitle">
                  Generate exportable slides based on a topic, text, YouTube
                  video, or any uploaded content.
                </p>

                {/* Grade Level */}
                <div className="pg-field">
                  <label className="pg-label">
                    Grade level: <span className="pg-required">*</span>
                  </label>
                ...
                <div className="pg-field">
                  <label className="pg-label">
                    Number of Slides: <span className="pg-required">*</span>
                  </label>
                  <div className="pg-select-wrapper">
                    <select
                      className="pg-select"
                ...
                >
                  ...
                  >
                    <div className="pg-textarea-wrapper" style={{ flex: 1 }}>
                      <div className="pg-textarea-icon">
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 24 24"
                      ...
                      <div className="pg-textarea-resize-handle">
                        <svg
                          width="10"
                          height="10"
                          viewBox="0 0 24 24"
                    ...
                    <div className="pg-field-footer-inner">
                      <label className="pg-file-btn">
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 24 24"
                  ...
                  <div className="pg-prompt-assistant-wrapper">
                    <button className="pg-prompt-assistant-btn">
                      <svg
                        width="14"
                        height="14"
                        viewBox="0 0 24 24"
                ...
                {/* Additional Criteria */}
                <div className="pg-field">
                  <label className="pg-label">Additional Criteria:</label>
                  <div className="pg-textarea-outer">
                    <div className="pg-textarea-wrapper">
                      <div className="pg-textarea-icon">
                        <svg
                          width="14"
                          height="14"
                      ...
                      <textarea
                        className="pg-textarea"
                        placeholder="Make sure that the slides include at least three questions throughout"
                        value={criteria}
                    ...
                    <div className="pg-field-footer-inner">
                      ...
                      <span className="pg-word-count">
                        Total word limit: {wordCount(criteria)}/75,000
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="pg-generate-row">
                  <button
                    className={`pg-generate-btn ${isGenerating ? "generating" : ""}`}
            ...
            {/* --- NEW OUTPUT AREA --- */}
            {!isEditorOpen && generatedPresentation && (
              <div
                className="pg-output-area"
                style={{
                  padding: "20px",
                  color: "white",
      ...
      <style jsx>{`
        ...
        .pg-textarea-outer:focus-within {
          border-color: #872de6;
        }
        ...
        .pg-prompt-assistant-wrapper {
          display: flex;
          justify-content: flex-end;
          margin-top: 0.2rem;
        }

        .pg-prompt-assistant-btn {
          display: flex;
          align-items: center;
          gap: 0.35rem;
          background: transparent;
