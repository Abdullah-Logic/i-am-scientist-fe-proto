...
const Generator = ({ type }: Props) => {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if (!title) {
      ...
      setFormError({
        title: "", // Clear the error for title
        subheading: "", // Clear the error for subheading (no validation needed)
        keywords: "", // Clear the error for keywords (no validation needed)
      });
  ...
  return (
    <div className="w-full flex flex-col md:flex-row  font-popins">
        <form
          ...
          <div className="flex flex-col gap-4 w-full">
            <div className="flex flex-col">
              ...
              <input
                ...
                className="contact-input bg-[#0F2A5B]"
              />
            </div>
            {formError?.title && (
