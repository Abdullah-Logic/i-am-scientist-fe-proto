...
export default function TextTranslator() {
  ...
  const handleGenerate = async () => {
    if (!originalText || !targetLanguage) {
      alert("Please provide both text and a target language.");
      return;
    }
    ...
    try {
      const response = await fetch(
        "https://api.iamscientist.ai/api/translator/translate",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...
            tone: "Educational", // Setting the tone as per backend requirement
          }),
        },
      );
      ...
      console.error("Translation Linking Error:", error);
      alert(
  ...
  return (
    <DashboardLayout activeTab="All Magic Tools">
      <div className="tt-page">
        ...
        <div className="tt-breadcrumb">
          <Link href="/teacher/tools" style={{ textDecoration: "none" }}>
            <span className="tt-breadcrumb-tools">Tools</span>
          </Link>
          <svg
            width="14"
            height="14"
          ...
          <span className="tt-breadcrumb-current">Text Translator</span>
        </div>
        <div className="tt-container">
          ...
          <div className="tt-panel">
            ...
            {isEditorOpen && (
              <div className="tt-form">
                ...
                <div className="tt-title-row">
                  <div className="tt-title-left">
                    <h1 className="tt-title">Text Translator</h1>
                    <button
                  ...
                  <button className="tt-exemplar-btn">Show exemplar</button>
                </div>

                <p className="tt-subtitle">
                  Translate any text or uploaded document into any language.
                </p>
                ...
                <div className="tt-field">
                  <label className="tt-label">
                    Language to translate to:{" "}
                    <span className="tt-required">*</span>
                  </label>
                  <div className="tt-input-wrapper">
                    ...
                    <input
                      type="text"
                      className="tt-input"
                      placeholder="Spanish, Vietnamese, Mandarin, Tagalog"
                ...
                >
                  <label className="tt-label">
                    Original Text: <span className="tt-required">*</span>
                  </label>
                  <div
                    className="tt-textarea-outer"
                    style={{
                      flex: 1,
                      display: "flex",
                  ...
                  >
                    <div className="tt-textarea-wrapper" style={{ flex: 1 }}>
                      <div className="tt-textarea-icon">
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 24 24"
                      ...
                      <div className="tt-textarea-resize-handle">
                        <svg
                          width="10"
                          height="10"
                          viewBox="0 0 24 24"
                    ...
                    <div className="tt-field-footer-inner">
                      <label className="tt-file-btn">
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 24 24"
                ...
                {/* Generate row */}
                <div className="tt-generate-row">
                  <button
                    className={`tt-generate-btn ${isGenerating ? "generating" : ""}`}
            ...
            {/* --- NEW TRANSLATED OUTPUT VIEW --- */}
            {!isEditorOpen && translatedResult && (
              <div
                className="tt-output-area"
                style={{
                  padding: "20px",
                  color: "white",
      ...
      <style jsx>{`
        ...
        .tt-textarea-outer:focus-within {
          border-color: #872de6;
        }
        ...
        .tt-generate-btn:active {
          transform: scale(0.98);
        }
        .tt-generate-btn.generating {
          opacity: 0.7;
          cursor: not-allowed;
        }
      `}</style>
