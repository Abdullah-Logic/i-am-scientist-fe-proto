  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch(
        "http://127.0.0.1:5328/api/worksheet/generate-worksheet",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            ...
            topic: topic,
            slo: "Aligned with SNC standards", // Defaulting as this field isn't in current UI
          }),
        },
      );
      ...
      console.error("Worksheet Linking Error:", error);
      alert(
        "Failed to connect to the backend. Ensure Flask is running on port 5328.",
      );
    } finally {
  ...
  return (
    <DashboardLayout activeTab="All Magic Tools">
      <div className="wg-page">
        ...
        <div className="wg-breadcrumb">
          <Link href="/teacher/tools" style={{ textDecoration: "none" }}>
            <span className="wg-breadcrumb-tools">Tools</span>
          </Link>
          <svg
            width="14"
            height="14"
          ...
          <span className="wg-breadcrumb-current">Worksheet Generator</span>
        </div>
          ...
          <div className="wg-panel">
            ...
            {isEditorOpen && (
              <div className="wg-form">
                {/* Title Row */}
                <div className="wg-title-row">
                  <h1 className="wg-title">Worksheet Generator</h1>
                  <button className="wg-exemplar-btn">
                    <svg
                      width="14"
                      height="14"
                      viewBox="0 0 24 24"
                ...
                <div className="wg-field">
                  <label className="wg-label">
                    Grade level: <span className="wg-required">*</span>
                  </label>
                  <div className="wg-select-wrapper">
                    <select
                      className="wg-select"
                      value={gradeLevel}
                ...
                >
                  <label className="wg-label">
                    Topic or text: <span className="wg-required">*</span>
                  </label>

                  <div
                    className="wg-textarea-outer"
                    style={{
                      flex: 1,
                      display: "flex",
                  ...
                  >
                    <div className="wg-textarea-wrapper" style={{ flex: 1 }}>
                      <div className="wg-textarea-icon">
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 24 24"
                      ...
                      <textarea
                        ...
                        placeholder="Mitosis, World War II, paste a block of text or attach a PDF of content to base the worksheet on."
                        value={topic}
                      ...
                      <div className="wg-textarea-resize-handle">
                        <svg
                          width="10"
                          height="10"
                          viewBox="0 0 24 24"
                    ...
                    <div className="wg-field-footer-inner">
                      <label className="wg-file-btn">
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 24 24"
                ...
                <div className="wg-assistant-row">
                  <button className="wg-prompt-assistant-btn">
                    <svg
                      width="14"
                      height="14"
                      viewBox="0 0 24 24"
                ...
                {/* Generate Button Row */}
                <div className="wg-generate-row">
                  <button
                    className={`wg-generate-btn ${isGenerating ? "generating" : ""}`}
            ...
            {/* --- NEW RESULT VIEW --- */}
            {!isEditorOpen && generatedWorksheet && (
              <div
                className="wg-output-area"
                style={{
                  padding: "20px",
                  color: "white",
      ...
      <style jsx>{`
        ...
        .wg-textarea-outer:focus-within {
          border-color: #872de6;
        }
        ...
        .wg-generate-btn:hover {
          opacity: 0.9;
        }
        .wg-generate-btn:active {
          transform: scale(0.98);
        }
        .wg-generate-btn.generating {
          opacity: 0.7;
          cursor: not-allowed;
        }
