...
import { GiArtificialHive, GiSoundWaves } from "react-icons/gi";
...
import seoImage1 from "../../public/seo-artilce-writer/seoImage1.webp";
import seoImage2 from "../../public/seo-artilce-writer/seoImage2.webp";

import seoImage3 from "../../public/seo-artilce-writer/seoImage3.webp";
import seoImage4 from "../../public/seo-artilce-writer/seoImage4.webp";

export const NAV_LINKS = [
  { id: 1, title: "Home", route: "/" },
  { id: 2, title: "About", route: "/about-us" },
  { id: 3, title: "AI Tools", route: "" },
  { id: 4, title: "Bypass AI", route: "/ai-bypass" },
  { id: 5, title: "APIs", route: "/api/home" },
  // { id: 6, title: "Pricing", route: "/#pricing" },
  { id: 6, title: "Pricing", route: "/pricing-plan" },
...
export const pricingData = [
  ...
  },
  {
    ...
    duration: "1 Month",
    link: "https://buy.stripe.com/8wM4jHdDXb7Nble7sM",
  },
  {
    id: 2,
    icon: BsSlack,
...
// affiliate program data blog end
...
export const MegaMenu: MegaMenuProps[] = [
  ...
  },
  {
    ...
    title: "Social Media",
    link: "/user/templates#SocialMedia",
    route: "/ai-social-media",
  ...
  },
  {
    ...
    icon: FaBook,
    title: "Course Builder",
    link: "/user/templates#CourseBuilder",
    route: "/ai-course-builder",
  ...
  },
  {
    ...
    link: "/user/seo-article-writer",
    route: "/seo-article-writer",
  ...
  // abstract
  {
    ...
    link: "/user/abstract-generator",
    route: "/abstract-generator",
  ...
  // Research Title
  {
    ...
    link: "/user/research-title",
    route: "/research-title",
    desc: "It helps to generate Research title ",
  },
];
...
export const Abstract: Steps[] = [
  {
    ...
    step: "Step#1",
    detail:
      "Access Intelliwriter Abstract Generator: Open your preferred web browser and navigate to the Intelliwriter.io website. Login and from the user dashboard choose what you want to create. ",
  ...
  },
  {
    ...
    step: "Step#2",
    detail:
      "The abstract generator includes a Write Text section, where users can manually input and edit content, and a Copy Text section, which automatically displays the copied version of the input text, ensuring a quick and seamless way to duplicate and reference the written content.",
